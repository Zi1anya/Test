...
<header class="header">
    <div class="container">
        <div class="header__inner">
            <div class="header__logo">Веб-приложение для контроля знаний учащихся на примере УО «Новопольский ГАЭК</div>
            <nav class="nav">
                <a class="nav__link active" href="vhod.php">Тесты</a>
                <a class="nav__link" href="ob_site_neavtoriz.php">О сайте</a>
                <a class="nav__link" href="vhod.php">Войти</a>
            </nav>
        </div>
    </div>
</header>
